...
//	var_dump($info_contenido);
	...
	if(isset($_POST['guardar']))
	{
		...
		echo "<script>alert('".strip_tags($final)."');document.location='index.php?id=".$id."&editar=".$id."'</script>";
	}
...
if(isset($_GET['nueva']))
{
	...
	if(isset($_POST['guardar']))
	{
		...
		echo "<script>alert('".strip_tags($final)."');document.location='index.php?id=".$query_ultimo->fields['ultimo']."&editar=".$query_ultimo->fields['ultimo']."'</script>";
	}
}
