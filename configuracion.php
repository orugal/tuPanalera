...
define('_NOMBRE_EMPRESA_MAIL'	                            ,'Tu Pañalera');			//Url desde el navegador
...
define('_MAILER'										,'mail');
define('_HOST_MAIL'										,'mail.tupanalera.com');//Configurar
define('_SMTP_AUTH'										,true);
define('_SMTP_USER'										,'info@tupanalera.com');//configurar
define('_SMTP_PASS'										,'S1s73m4s');//configurar
define('_ES_HTML'										,true);
//Correo del administrador
define('_MAIL_ADMIN'									,'lorenamesag88@gmail.com');//
